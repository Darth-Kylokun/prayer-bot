...
class Help(Cog):
    ...
    async def help(self, ctx: Context):
        ...
        embed.add_field(name="> addprayer <name> <prayer> | alias ap", value="Stores a prayer dedicated to an entity", inline=False)
        embed.add_field(name="> prayers <name> | alias p", value="Shows stored prayers for that entity and gives the prayers id along with them", inline=False)
        embed.add_field(name="> entities | alias e", value="Shows all entities you have added", inline=False)
        embed.add_field(name="> removeprayer <name> <id> | alias rp", value="Removes a prayer from an entity and the rest of the prayer IDs might change", inline=False)
        embed.add_field(name="> removeentity <name> | alias re", value="Removes an entity", inline=False)
